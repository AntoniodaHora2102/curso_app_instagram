...
class CameraFragment : Fragment() {
    ...
    private fun takePhoto() {
        ...
        //parametro que ira salvar a foto
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            //ira reduzir a resolução da foto
            ...
            //ira ativar a camera traseira
            val cameraSelector = CameraSelector.DEFAULT_BACK_CAMERA
                try {
                    cameraProvider.unbindAll() //ira desconecta camera presente
                    cameraProvider.bindToLifecycle(this, cameraSelector,
                        preview, imageCapture) //ciclo de vida do fragment / camera que ira conectar / onde sera aberta a camera
